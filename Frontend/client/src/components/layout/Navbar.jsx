...
const pageTitles = {
  ...
  "/admin/students": {
    title: "Students",
    subtitle: "Manage students and user accounts",
  },
  "/admin/borrow-records": {
    title: "Borrow Records",
    subtitle: "Track borrowing and return activity",
  },
  "/admin/reports": {
    title: "Reports",
    subtitle: "Review library analytics and insights",
  },
  "/admin/profile": {
    title: "Profile",
...
const Navbar = ({
  ...
  const handleSearch = (event) => {
    ...
    if (event.key === "Enter" && searchValue) {
      navigate(
        `/admin/books?search=${encodeURIComponent(searchValue)}`
      );
    }
  };
