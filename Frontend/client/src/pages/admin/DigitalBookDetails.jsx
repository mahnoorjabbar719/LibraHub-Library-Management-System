  ...
  const handleRead = () => {
    if (!pdfUrl) {
      Swal.fire({
        ...
        text: "This digital book does not have a PDF file.",
        confirmButtonColor: "#059669",
      });
  ...
  const handleDownload = () => {
    if (!pdfUrl) {
      Swal.fire({
        icon: "warning",
        title: "PDF not available",
        text: "This digital book does not have a downloadable PDF.",
        confirmButtonColor: "#059669",
      });
    ...
    if (book.allowDownload === false) {
      Swal.fire({
        ...
        text: "Downloading is disabled for this digital book.",
        confirmButtonColor: "#059669",
      });
          ...
          <div className="flex flex-col p-7 lg:p-10">
            ...
            <div className="mt-7">
              ...
              <p className="mt-3 whitespace-pre-line leading-7 text-slate-600">
                {book.description ||
                  "No description has been added for this digital book."}
              </p>
            </div>
            ...
            <div className="mt-auto flex flex-col gap-3 border-t border-slate-200 pt-8 sm:flex-row">
              <button
                type="button"
                onClick={handleRead}
                className="flex flex-1 items-center justify-center gap-2 rounded-xl bg-emerald-600 px-5 py-3.5 text-sm font-bold text-white shadow-lg shadow-emerald-600/20 transition hover:-translate-y-0.5 hover:bg-emerald-700"
              >
              ...
              <button
                ...
                disabled={book.allowDownload === false}
...
export default DigitalBookDetails;